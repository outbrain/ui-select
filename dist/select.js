 ...
 * Version: 0.13.2 - 2016-01-12T14:44:47.011Z
 * License: MIT
 */
...
uis.controller('uiSelectCtrl',
  ['$scope', '$element', '$timeout', '$filter', '$q', '$log', 'uisRepeatParser', 'uiSelectMinErr', 'uiSelectConfig', '$parse',
  function($scope, $element, $timeout, $filter, $q, $log, RepeatParser, uiSelectMinErr, uiSelectConfig, $parse) {
...
$templateCache.put("selectize/select.tpl.html","<div class=\"ui-select-container selectize-control single\" ng-class=\"{\'open\': $select.open, \'searchable\': $select.searchEnabled, \'not-searchable\': !$select.searchEnabled}\"><div class=\"selectize-input\" ng-class=\"{\'focus\': $select.open, \'disabled\': $select.disabled, \'selectize-focus\' : $select.focus}\" ng-click=\"$select.activate()\"><div class=\"ui-select-match\"></div><input type=\"text\" autocomplete=\"false\" tabindex=\"-1\" class=\"ui-select-search ui-select-toggle\" ng-click=\"$select.toggle($event)\" ng-class=\"{\'ui-select-search-disabled\' : !$select.searchEnabled}\" placeholder=\"{{$select.placeholder}}\" ng-model=\"$select.search\" ng-hide=\"($select.selected && !$select.open)\" ng-disabled=\"$select.disabled\" aria-label=\"{{ $select.baseTitle }}\"></div><div class=\"ui-select-choices\"></div></div>");}]);
